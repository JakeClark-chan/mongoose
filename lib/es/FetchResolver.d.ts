...
export declare type Fetcher = {
    fetch: (environment: IEnvironment, operation: OperationDescriptor, fetchPolicy: FetchPolicy | null | undefined, onComplete: (_e: Error | null) => void, onNext: (operation: OperationDescriptor, snapshot: Snapshot, fromStore?: boolean, onlyStore?: boolean) => void, onResponse?: (response: GraphQLResponse | null) => void, renderPolicy?: RenderPolicy) => Disposable;
    getData: () => {
        isLoading: boolean;
        error?: Error | null;
    };
