...
function () {
  function FragmentResolver(name) {
    ...
    this.refetch = function (variables, options) {
      ...
      var _e = relayRuntime.getRefetchMetadata(_this._fragment, _this.name),
      ...
      return _this.fetcherRefecth.fetch(_this._environment, operation, options === null || options === void 0 ? void 0 : options.fetchPolicy, options === null || options === void 0 ? void 0 : options.onComplete, onNext, options === null || options === void 0 ? void 0 : options.onResponse, options === null || options === void 0 ? void 0 : options.UNSTABLE_renderPolicy);
    };
    ...
    this.loadMore = function (direction, count, options) {
      ...
      onComplete, onNext, options === null || options === void 0 ? void 0 : options.onResponse);
    };
...
function useRefetchableSubscription(fragmentInput, fragmentRef, callback) {
...
exports.usePaginationSubscription = usePaginationSubscription;
...
exports.useRefetchableSubscription = useRefetchableSubscription;
...
//# sourceMappingURL=relay-hooks.js.map
