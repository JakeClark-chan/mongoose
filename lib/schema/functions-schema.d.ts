...
import { CollectionDataModel, CollectionModel, PushTokenModel, RestaurantDataModel, UserAuthModel, UserDataModel, UserModel } from "./schema";
...
export declare enum FOLLOWOBJECTTYPEENUM {
