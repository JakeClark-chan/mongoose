...
class ParserATNSimulator extends _ATNSimulator.default {
    ...
    canDropLoopEntryEdgeInLeftRecursiveRule(config) {
        ...
        if (p.stateType !== _ATNState.default.STAR_LOOP_ENTRY)
            return false;
        if (p.stateType !== _ATNState.default.STAR_LOOP_ENTRY || !p.isPrecedenceDecision || config.context.isEmpty() || config.context.hasEmptyPath())
            return false;
        ...
        for (let i = 0; i < numCtxs; i++) {
            ...
            if (returnState.stateType === _ATNState.default.BLOCK_END && returnStateTarget === p)
                continue;
            ...
            if (returnStateTarget.stateType === _ATNState.default.BLOCK_END && returnStateTarget.transitions.length === 1 && returnStateTarget.transitions[0].isEpsilon && returnStateTarget.transitions[0].target === p)
                continue;
