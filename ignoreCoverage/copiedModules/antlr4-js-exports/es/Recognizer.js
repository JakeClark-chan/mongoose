...
const ConsoleErrorListener_js_1 = __importDefault(require("./error/ConsoleErrorListener.js"));
const ProxyErrorListener_js_1 = __importDefault(require("./error/ProxyErrorListener.js"));
class Recognizer {
    constructor() {
