 ...
 */
const RuleContext_js_1 = __importDefault(require("./RuleContext.js"));
const PredictionContext_js_1 = __importDefault(require("./PredictionContext.js"));
const ArrayPredictionContext_js_1 = __importDefault(require("./ArrayPredictionContext.js"));
const SingletonPredictionContext_js_1 = __importDefault(require("./SingletonPredictionContext.js"));
const EmptyPredictionContext_js_1 = __importDefault(require("./EmptyPredictionContext.js"));
...
function getCachedPredictionContext(context, contextCache, visited) {
    ...
    if (parents.length === 0) {
        ...
        updated = SingletonPredictionContext_js_1.default.create(parents[0], context.getReturnState(0));
    }
    else {
...
function mergeArrays(a, b, rootIsWildcard, mergeCache) {
    if (mergeCache !== null) {
        ...
        if (previous !== null) {
            if (PredictionContext_js_1.default.trace_atn_sim)
    ...
    while (i < a.returnStates.length && j < b.returnStates.length) {
        ...
        if (a.returnStates[i] === b.returnStates[j]) {
            ...
            // $+$ = $
            const bothDollars = payload === PredictionContext_js_1.default.EMPTY_RETURN_STATE && a_parent === null && b_parent === null;
    ...
    if (PredictionContext_js_1.default.trace_atn_sim)
        console.log("mergeArrays a=" + a + ",b=" + b + " -> " + M);
    return M;
}
/**
...
function mergeRoot(a, b, rootIsWildcard) {
    if (rootIsWildcard) {
        ...
        else if (a === PredictionContext_js_1.default.EMPTY) {
            // $ + x = [$,x]
            const payloads = [b.returnState, PredictionContext_js_1.default.EMPTY_RETURN_STATE];
            const parents = [b.parentCtx, null];
            return new ArrayPredictionContext_js_1.default(parents, payloads);
        }
        else if (b === PredictionContext_js_1.default.EMPTY) {
