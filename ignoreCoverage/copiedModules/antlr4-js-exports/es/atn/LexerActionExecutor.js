...
const LexerIndexedCustomAction_js_1 = __importDefault(require("../action/LexerIndexedCustomAction.js"));
...
class LexerActionExecutor {
    ...
    fixOffsetBeforeMatch(offset) {
        ...
        for (let i = 0; i < this.lexerActions.length; i++) {
            if (this.lexerActions[i].isPositionDependent && !(this.lexerActions[i] instanceof LexerIndexedCustomAction_js_1.default)) {
