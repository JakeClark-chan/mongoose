...
const AltDict_js_1 = __importDefault(require("../misc/AltDict.js"));
...
const PredictionMode = {
            ...
            if (configs.hasSemanticContext) {
                ...
                for (let i = 0; i < configs.items.length; i++) {
                    ...
                    c = new ATNConfig_js_1.default({
                        semanticContext: SemanticContext_js_1.default.NONE
                    }, c);
                    dup.add(c);
                }
                configs = dup;
    ...
    getConflictingAltSubsets: function (configs) {
        ...
        configToAlts.hashFunction = function (cfg) {
            HashCode_js_1.default.hashStuff(cfg.state.stateNumber, cfg.context);
        };
