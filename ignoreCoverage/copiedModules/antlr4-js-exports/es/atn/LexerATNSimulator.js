...
const OrderedATNConfigSet_js_1 = __importDefault(require("./OrderedATNConfigSet.js"));
...
const LexerATNConfig_js_1 = __importDefault(require("./LexerATNConfig.js"));
const Transition_js_1 = __importDefault(require("../transition/Transition.js"));
const LexerActionExecutor_js_1 = __importDefault(require("./LexerActionExecutor.js"));
const LexerNoViableAltException_js_1 = __importDefault(require("../error/LexerNoViableAltException.js"));
...
class LexerATNSimulator extends ATNSimulator_js_1.default {
        ...
        for (let i = 0; i < closure.items.length; i++) {
            ...
            for (let j = 0; j < cfg.state.transitions.length; j++) {
                ...
                if (target !== null) {
                    ...
                    const config = new LexerATNConfig_js_1.default({
                        state: target,
    ...
    computeStartState(input, p) {
        ...
        for (let i = 0; i < p.transitions.length; i++) {
            ...
            const cfg = new LexerATNConfig_js_1.default({
                state: target,
                alt: i + 1,
        ...
        if (config.state instanceof RuleStopState_js_1.default) {
            ...
            if (config.context === null || config.context.hasEmptyPath()) {
                if (config.context === null || config.context.isEmpty()) {
                    ...
                    configs.add(new LexerATNConfig_js_1.default({
                        state: config.state,
            ...
            if (config.context !== null && !config.context.isEmpty()) {
                for (let i = 0; i < config.context.length; i++) {
                    if (config.context.getReturnState(i) !== PredictionContext_js_1.default.EMPTY_RETURN_STATE) {
                        ...
                        cfg = new LexerATNConfig_js_1.default({
                            state: returnState,
                            context: newContext
                        }, config);
    ...
    getEpsilonTarget(input, config, trans, configs, speculative, treatEofAsEpsilon) {
        ...
        else if (trans.serializationType === Transition_js_1.default.ATOM || trans.serializationType === Transition_js_1.default.RANGE || trans.serializationType === Transition_js_1.default.SET) {
