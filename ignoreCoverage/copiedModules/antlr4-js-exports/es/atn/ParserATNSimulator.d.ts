...
export default class ParserATNSimulator extends ATNSimulator {
     ...
     * returns {@link //ERROR
     */
    computeTargetState(dfa: any, previousD: any, t: any): DFAState;
    ...
    computeStartState(p: any, ctx: any, fullCtx: any): ATNConfigSet;
    /**
     ...
     */
    applyPrecedenceFilter(configs: any): ATNConfigSet;
    getReachableTarget(trans: any, ttype: any): any;
    getPredsForAmbigAlts(ambigAlts: any, configs: any, nalts: any): any[];
    getPredicatePredictions(ambigAlts: any, altToPred: any): PredPrediction[] | null;
    /**
    ...
    splitAccordingToSemanticValidity(configs: any, outerContext: any): ATNConfigSet[];
    /**
     ...
     */
    evalSemanticContext(predPredictions: any, outerContext: any, complete: any): BitSet;
    ...
    getEpsilonTarget(config: any, t: any, collectPredicates: any, inContext: any, fullCtx: any, treatEofAsEpsilon: any): ATNConfig | null;
    actionTransition(config: any, t: any): ATNConfig;
    precedenceTransition(config: any, pt: any, collectPredicates: any, inContext: any, fullCtx: any): ATNConfig | null;
    predTransition(config: any, pt: any, collectPredicates: any, inContext: any, fullCtx: any): ATNConfig | null;
    ruleTransition(config: any, t: any): ATNConfig;
    getConflictingAlts(configs: any): BitSet;
    /**
    ...
    noViableAlt(input: any, outerContext: any, configs: any, startIndex: any): NoViableAltException;
