...
const ErrorNode_js_1 = __importDefault(require("./tree/ErrorNode.js"));
const Recognizer_js_1 = __importDefault(require("./Recognizer.js"));
const DefaultErrorStrategy_js_1 = __importDefault(require("./error/DefaultErrorStrategy.js"));
const ATNDeserializer_js_1 = __importDefault(require("./atn/ATNDeserializer.js"));
const ATNDeserializationOptions_js_1 = __importDefault(require("./atn/ATNDeserializationOptions.js"));
const TraceListener_js_1 = __importDefault(require("./TraceListener.js"));
class Parser extends Recognizer_js_1.default {
    ...
    getATNWithBypassAlts() {
        ...
        if (result === null) {
            ...
            result = new ATNDeserializer_js_1.default(deserializationOptions).deserialize(serializedAtn);
