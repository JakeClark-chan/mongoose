...
exports.JavaAntlr4CstPrinter = void 0;
const JavaParser_1 = __importDefault(require("./JavaParser"));
const MyAntlr4_1 = require("../../util/MyAntlr4");
const JavaParserListener_1 = __importDefault(require("./JavaParserListener"));
class JavaAntlr4CstPrinter extends JavaParserListener_1.default {
    // define static method
    static print(ctx, key) {
        console.log("++++++++++++++++");
        console.log("key: " + key);
        let listener = new JavaAntlr4CstPrinter();
        let ast = listener.buildAST(ctx, JavaParser_1.default.ruleNames);
        console.log(JSON.stringify(ast, null, 2));
        console.log("++++++++++++++++");
    }
    buildAST(tree, ruleNames) {
        ruleNames = ruleNames || null;
        let s = MyAntlr4_1.antlr4.tree.Trees.getNodeText(tree, ruleNames);
...
exports.JavaAntlr4CstPrinter = JavaAntlr4CstPrinter;
