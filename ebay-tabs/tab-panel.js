...
var TabPanel = function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({}, rest, { "aria-labelledby": "default-tab-".concat(index), className: (0, classnames_1.default)(className, 'tabs__panel'), id: "".concat(parentId || 'default', "-tabpanel-").concat(index), role: "tabpanel", hidden: !selected }),
