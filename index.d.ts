// v5.27320.0
// Generated by KoLmafia r27320 with type generator v5
...
export function equippedAmount(arg0: Item, arg1: boolean): number;
...
export function numericModifier(arg: Thrall, modifier: string): number;
...
export function userNotify(message: string): void;
...
declare abstract class MafiaClass {
    ...
    static get<T extends MafiaClass>(names: readonly (string | number)[]): T[];
...
export class Bounty extends MafiaClass {
    ...
    static get(names: readonly string[]): Bounty[];
...
export type ClassType = "Accordion Thief" | "Avatar of Boris" | "Avatar of Jarlsberg" | "Avatar of Sneaky Pete" | "Beanslinger" | "Cheese Wizard" | "Cow Puncher" | "Disco Bandit" | "Ed the Undying" | "Gelatinous Noob" | "Grey Goo" | "Jazz Agent" | "Pastamancer" | "Pig Skinner" | "Plumber" | "Sauceror" | "Seal Clubber" | "Snake Oiler" | "Turtle Tamer" | "Vampyre" | "Zombie Master";
export class Class extends MafiaClass {
    static get(name: (ClassType | number)): Class;
    static get(names: readonly (ClassType | number)[]): Class[];
...
export class Coinmaster extends MafiaClass {
    ...
    static get(names: readonly string[]): Coinmaster[];
...
export class Effect extends MafiaClass {
    ...
    static get(names: readonly (string | number)[]): Effect[];
...
export class Element extends MafiaClass {
    ...
    static get(names: readonly ElementType[]): Element[];
...
export class Familiar extends MafiaClass {
    ...
    static get(names: readonly (string | number)[]): Familiar[];
...
export class Item extends MafiaClass {
    ...
    static get(names: readonly (string | number)[]): Item[];
    static all<T = Item>(): T[];
    static none: Item;
    /**
     * Name */
...
export class Location extends MafiaClass {
    ...
    static get(names: readonly (string | number)[]): Location[];
...
export class Monster extends MafiaClass {
    ...
    static get(names: readonly (string | number)[]): Monster[];
...
export class Path extends MafiaClass {
    ...
    static get(names: readonly string[]): Path[];
    static all<T = Path>(): T[];
    static none: Path;
    /**
     * Id */
...
export class Phylum extends MafiaClass {
    ...
    static get(names: readonly PhylumType[]): Phylum[];
...
export class Servant extends MafiaClass {
    ...
    static get(names: readonly (ServantType | number)[]): Servant[];
...
export class Skill extends MafiaClass {
    ...
    static get(names: readonly (string | number)[]): Skill[];
...
export class Slot extends MafiaClass {
    ...
    static get(names: readonly (SlotType | number)[]): Slot[];
    static all<T = Slot>(): T[];
    static none: Slot;
    toString(): SlotType;
}
...
export class Stat extends MafiaClass {
    ...
    static get(names: readonly StatType[]): Stat[];
    static all<T = Stat>(): T[];
    static none: Stat;
    toString(): StatType;
}
...
export class Thrall extends MafiaClass {
    ...
    static get(names: readonly (ThrallType | number)[]): Thrall[];
...
export class Vykea extends MafiaClass {
    ...
    static get(names: readonly string[]): Vykea[];
